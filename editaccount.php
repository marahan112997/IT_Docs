        ...
        <div class="card-body">
          <form method="POST" action="updateaccount.php" >
			...
			<?php
				...
				?>
				<input type="hidden" name="privilege" value="<?php echo $row['privilege'];?>" class="form-control" placeholder="Username" required="required">
				<input type="hidden" name="team" value="<?php echo $row['team'];?>" class="form-control" placeholder="Username" required="required">
