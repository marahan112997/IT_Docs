  	...
  	$name=$uniq.'.pdf';
		...
		if (isset($name)) {
			...
			if (!empty($name)){
				...
				echo mysqli_query($conn, "INSERT INTO tbl_ser(ser_id, ser_title, temp_title,approved_date,ser_number,expiration_date)VALUES('','$ser_title', '$uniq', '$approved_date','$ser_number','$expiration_date')");
          ...
          <form action="#file" method='post' enctype="multipart/form-data">
            ...
            <div class="form-group">
              <div class="form-row">
				...
				<div class="col-md-6">
                  <div class="form-label-group">
                    <input  class="form-control"  type="text" name="ser_number" required="required" autocomplete="off">
